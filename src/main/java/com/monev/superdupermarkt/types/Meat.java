...
/**
 * Represents a type of meat product in the SuperDuperMarket system. This class
 * extends the Product class and adds specific attributes and behaviors related
 * to meat, such as its type and whether it is vacuum packed.
 */
public class Meat extends Product {
   ...
   /**
    * Constructs a Meat product with the specified properties. Performs validation
    * to ensure the quality and expiry date are appropriate based on whether the
    * meat is vacuum packed or not.
    *
    ...
    */
   public Meat(String id, String name, double quality, LocalDate expiryDate, double defaultPrice, MeatTypeEnum meatType,
      ...
      // Automatically calculate expiration date if not vacuum packed and no
   ...
   /**
    * Updates the quality of the meat based on its expiry status. Meat loses
    * quality faster after its expiry date.
    */
   @Override
   ...
   /**
    * Calculates the expiry date for fresh meat based on the meat type. The expiry
    * date is determined by adding a specific number of days to the current date.
    *
