...
class ProductImporterSQLTest {
   ...
   void setUp() throws Exception {
      ...
      try (Statement stmt = connection.createStatement()) {
         ...
         String createTableSQL = "CREATE TABLE products (" + "type VARCHAR(50), " + "id VARCHAR(50), "
               + "name VARCHAR(50), " + "quality INT, " + "expiry_date DATE, " + "base_price DOUBLE)";
   ...
   @Test
   void testImportFromSQL() {
      // Import products from the SQL database
