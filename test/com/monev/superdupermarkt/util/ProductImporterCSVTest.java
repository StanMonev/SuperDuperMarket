...
public class ProductImporterCSVTest {
    ...
    public void testReadProductsFromCSV() throws IOException {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(tempFile))) {
            writer.write("type,id,quality,expiryDate,defaultPrice\n");
        ...
        // Use the CSVReader to import products
        ...
        assertEquals(cheeseExpiryDate, cheese.getExpiryDate(), "Cheese expiry date should be 15-09-2024.");
        ...
        assertEquals(wineExpiryDate, wine.getExpiryDate(), "Wine expiry date should be 10-12-2024.");
        ...
        assertEquals(commonProductExpiryDate, commonProduct.getExpiryDate(), "Common Product expiry date should be 01-11-2024.");
