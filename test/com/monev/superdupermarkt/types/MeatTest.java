...
class MeatTest {
    ...
    void setUp() {
        ...
        meat = new Meat("MT001", "Beef Steak", 60, validExpiryDate, 15.00, MeatType.BEEF, false);
        vacuumPackedMeat = new Meat("MT002", "Lamb Chops", 62, validVacuumPackedExpiryDate, 20.00, MeatType.LAMB, true);
    }
    ...
    void testInvalidMeatQualityBelowThreshold() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
            new Meat("MT003", "Chicken Breast", 49, validDate, 8.00, MeatType.POULTRY, false)
        );
    ...
    void testInvalidFreshMeatExpiryDate() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
            new Meat("MT004", "Pork Loin", 55, invalidExpiryDate, 10.00, MeatType.PORK, false)
        );
    ...
    void testInvalidVacuumPackedMeatExpiryDate() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
            new Meat("MT005", "Venison", 58, invalidExpiryDate, 18.00, MeatType.VENISON, true)
        );
    ...
    void testExpiredMeatQualityDecrease() {
        Meat expiredMeat = new Meat("MT006", "Expired Pork", 55, LocalDate.now().plusDays(3), 10.00, MeatType.PORK, false);
